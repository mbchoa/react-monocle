module.exports = {
  htmlElements: [
    ...
    'foreignObject', 'frame', 'g', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'header', 'hr', 'html',
    'hr', 'i', 'iframe', 'img', 'input', 'kbd', 'label', 'legend', 'li', 'link', 'main', 'map',
    'menu', 'noscript', 'object', 'ol', 'option', 'p', 'path', 'param', 'pre', 'progress', 'q',
    'rb', 'rt', 'ruby', 's', 'samp', 'script', 'section', 'select', 'small', 'source', 'span',
